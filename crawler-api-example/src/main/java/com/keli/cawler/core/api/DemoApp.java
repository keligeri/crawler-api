...
public class DemoApp {
  ...
  public static void main(String[] args) {
    PaginationSelector paginationSelector = new PaginationSelector("sr_pagination_link");
    ...
    HtmlParser<House> parser = new HtmlParser<>(paginationStrategy, htmlItemSelector);
    List<House> houses = parser.parseItems();
